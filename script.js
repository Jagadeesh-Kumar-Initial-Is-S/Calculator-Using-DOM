...
var html1='<form class="calculatorForm" name="calculatorForm"><div class="screen"><input type="text" name="screen" class="screen" value="" readonly /></div><div class="btn"><input type="button" name="clear" value="C"  onclick="Clear()" /><button type="button" id="back" ><img src="icons8-back-arrow-50.png" onclick="back1()"/></button></div><div class="btn" id="d"><input type="button" name="num1" value="1" onclick="valueButton(this)" /><input type="button" name="num2" value="2" onclick="valueButton(this)" /><input type="button" name="num3" value="3" onclick="valueButton(this)" /><input type="button" name="plus" value="+" onclick="valueButton(this)" /></div><div class="btn"><input type="button" name="num4" value="4" onclick="valueButton(this)" /><input type="button" name="num5" value="5" onclick="valueButton(this)" /><input type="button" name="num6" value="6" onclick="valueButton(this)" />';
